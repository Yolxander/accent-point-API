...
def convert_audio_to_wav(input_file, output_path):
    ...
    try:
        ...
        try:
            ...
            # Ensure it's in the right format (mono or stereo)
            ...
            # If soundfile fails, try with librosa
            try:
                import librosa
                ...
                return False, f"Both soundfile and librosa failed: {str(e)} | {str(e2)}"
        ...
        if st.button("🚀 Start Conversion", type="primary", use_container_width=True):
            if input_file and reference_file:
                ...
                if success:
                    ...
                    # Convert input file to proper WAV format
                    conversion_success, error_msg = convert_audio_to_wav(input_file, output_path)
                    ...
                    if conversion_success:
                        ...
                        st.error(f"❌ Audio conversion failed: {error_msg}")
                else:
